      ...
      <IonContent>
        <IonRow className="ion-text-center ion-margin">
          <IonCol>
            <IonCard>
              <IonCardHeader>
                <IonCardTitle>Repairs Todo List</IonCardTitle>
              </IonCardHeader>
            </IonCard>
          </IonCol>
        </IonRow>
                ...
                <IonCol>
                  <IonCard>
                    <IonCardHeader className="cardhead">
                      <IonCardTitle>
                        EngineerID:
                        {item["EngineerID"] ? item["EngineerID"] : "Unassigned"}
                      </IonCardTitle>
                    </IonCardHeader>
                    <IonCardSubtitle>AssetID:{item["AssetID"]}</IonCardSubtitle>
                    <IonCardContent>
                      <IonText>
                        Created Date:{" "}
                      ...
                      >
                        <IonButton color="danger">Fix</IonButton>
                      </Link>
                    </IonCardContent>
                  </IonCard>
                </IonCol>
