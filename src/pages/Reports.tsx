...
const Reports: React.FC = () => {
  ...
  const searchReports: any = (repairJSON: string) => {
    ...
    return axios
      .post(`http://localhost:3000/report/getReports`, repairJSON)
      .then((response) => {
    ...
    <IonPage>
      ...
      <IonHeader>
        <IonToolbar color="danger">
          ...
          <IonTitle>Report Generation</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent>
        <IonGrid className="ion-text-center ion-margin">
                    ...
                    <IonCol>
                      <IonItem>
                        <IonInput
                          value={initialDate}
                          type="date"
                          onIonChange={(e) => setinitialDate(e.detail.value!)}
                        >
                          From:{" "}
                        </IonInput>
                      </IonItem>
                    ...
                    <IonCol>
                      <IonItem>
                        <IonInput
                          value={finalDate}
                          type="date"
                          onIonChange={(e) => setfinalDate(e.detail.value!)}
                        >
                          To:{" "}
                        </IonInput>
                      </IonItem>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <IonCardHeader mode="ios" className="cardhead">
                  <IonCardTitle>
                    Inspection Report - Signal Tests and Inspections
                  </IonCardTitle>
                </IonCardHeader>
                <IonCardContent>
                  <IonRow>
                  ...
                  <IonRow>
                    <IonCol>
                      <IonLabel position="fixed">
                        Subdivison:{subdivision ? subdivision : ""}
                      </IonLabel>
                      <br />
                      <br />
                    </IonCol>
            ...
            <IonCol>
              <IonCard>
                <IonCardHeader mode="ios" className="cardhead">
                  <IonRow>
                    <IonCol>
                      <IonCardTitle>Inspections and Repairs</IonCardTitle>
                    </IonCol>
                  </IonRow>
                  <IonRow>
                    <IonCol size="4">
                      <IonCardSubtitle>Test Module No</IonCardSubtitle>
                    </IonCol>
                    <IonCol size="4">
                      <IonCardSubtitle>Test Descripton</IonCardSubtitle>
                    </IonCol>
                    <IonCol size="4">
          ...
          <IonRow>
            <IonCol>
              <IonButton color="primary" size="large" expand="block">
                Send to email
              </IonButton>
            </IonCol>
          </IonRow>
